...
export const AppRoutes: Route[] = [

  {
    ...
    children: [
      {
        path: '', loadChildren: () => {
          if ((new AdminStateService()).isAdmin) {
            return import('app/modules/admin/admin-home/admin-home.module').then(m => m.AdminHomeModule)
          } else {
            return import('app/modules/landing/totem-home-page/totem-home-page.module').then(m => m.TotemHomePageModule)
          }
        }
      },
  ...
  //   children: [
  //     { path: '', loadChildren: () => import('app/modules/admin/admin-home/admin-home.module').then(m => m.AdminHomeModule) },
  ...
  //     { path: 'submit-game', loadChildren: () => import('@app/modules/specific/add-your-game/add-your-game.module').then(m => m.AddYourGameModule) },
  ...
  //     { path: 'approve-game', loadChildren: () => import('@app/modules/specific/admin/admin.module').then(m => m.AdminModule) },
  //   ]
  // },
