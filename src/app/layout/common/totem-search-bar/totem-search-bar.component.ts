...
import { Items } from '@app/layout/components/totem-navigation/totem-search-filter/models/items-interface.model';
import { GradientService } from '@app/layout/components/totem-navigation/totem-search-filter/services/items-gradient.service';

@Component({
  selector: 'totem-search-bar',
  templateUrl: './totem-search-bar.component.html',
  styleUrls: ['./totem-search-bar.component.scss'],
})
export class TotemSearchBarComponent extends OnDestroyMixin implements OnInit, OnDestroy {
